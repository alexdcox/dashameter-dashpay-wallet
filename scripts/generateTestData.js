...
async function initWallet(user) {
  ...
  const clientOpts = {
    ...
    apps: {
      dpns: {contractId: import.meta.env.VUE_APP_DPNS_CONTRACT_ID},
      dashpayWallet: {
        contractId:
          import.meta.env.VUE_APP_DASHPAY_WALLET_CONTRACT_ID_local ||
          import.meta.env.VUE_APP_DASHPAY_WALLET_CONTRACT_ID_testnet ||
          import.meta.env.VUE_APP_DASHPAY_WALLET_CONTRACT_ID_build_testnet,
      },
      dashpay: {
        contractId: import.meta.env.VUE_APP_DASHPAY_CONTRACT_ID,
      },
    },
  }
